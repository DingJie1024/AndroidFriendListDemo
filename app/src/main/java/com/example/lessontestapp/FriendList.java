...
public class FriendList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hintAppCloseServiceIntent = new Intent(this, HintAppCloseService.class);
...
//                friendInfoMap.put(i,friendList);
        ...
        friendAdpter = new MyFriendAdapter(this,friendDaoList);
        mFriendListView = findViewById(R.id.idActivityFriendListView);
        ...
        //toolbar
        mToolbar = findViewById(R.id.id_friend_list_toolbar);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.idInnerStorageImport:
                        ...
                        try {
                            FileInputStream fis = openFileInput(INNER_STORAGE_FILE_NAME);
                    ...
                    case R.id.idInnerStorageExport:
                        ...
                        try {
                            FileOutputStream fos = openFileOutput(INNER_STORAGE_FILE_NAME,MODE_APPEND);
                    ...
                    case R.id.idOuterStorageImport:
                        ...
                        if (ActivityCompat.checkSelfPermission(FriendList.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                == PackageManager.PERMISSION_GRANTED){
                            if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
                                try {
                                    String filename = getExternalFilesDir("Music").getCanonicalPath()+"/"+OUTER_STORAGE_FILE_NAME;
                            ...
                            //没有授权
                            ActivityCompat.requestPermissions(FriendList.this,new String[]{
    ...
    public ArrayList<String> addTranmitedData(int select_item){
        ...
        infoDataTranmitList.add(new String(friendDaoList.get(select_item).getProfile()));
    ...
    //封装好友列表所有的信息
    public void getAllFriendsListInfo(){
    ...
    protected void onStart() {
        super.onStart();
        bindService(hintAppCloseServiceIntent,conn,Context.BIND_AUTO_CREATE);
    }
    ...
    protected void onDestroy() {
        ...
        unbindService(conn);
        //开启服务
        Intent intent = new Intent(this, HintAppCloseService.class);
